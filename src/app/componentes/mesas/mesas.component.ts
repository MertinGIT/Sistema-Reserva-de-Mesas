...
@Component({
  ...
  template: `
    <div class="tab-content">
      ...
      <div class="list">
        <div *ngFor="let mesa of mesas" class="list-item">
          <div class="list-item-content">
            <h3><i class="fas fa-table"></i> Mesa {{ mesa.numero }}</h3>
            <div class="info-row">
              <span class="badge"><i class="fas fa-users"></i> {{ mesa.capacidad }} personas</span>
              <span class="badge"><i class="fas fa-map-marker-alt"></i> {{ obtenerNombreZona(mesa.zonaId) }}</span>
              <span class="badge"><i class="fas fa-store"></i> {{ obtenerNombreRestaurantePorZona(mesa.zonaId) }}</span>
            </div>
          </div>
